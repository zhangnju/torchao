...
class MXFP8OnDeviceAllToAllV(torch.autograd.Function):
    ...
    def backward(
        ...
        if MXFP8OnDeviceAllToAllV.grad_input_expert_splits_buf is None:
            MXFP8OnDeviceAllToAllV.grad_input_expert_splits_buf = torch.empty(
        ...
        _mxfp8_on_device_all_to_all_v(
            ...
            MXFP8OnDeviceAllToAllV.expert_splits_sym_mem_buf,  # expert splits
            ...
            MXFP8OnDeviceAllToAllV.grad_input_expert_splits_buf,  # output expert splits
...
def _mxfp8_all_to_all_v_kernel(
    ...
    if tl.program_id(0) == 0:
        ...
        for expert_idx in range(num_experts_per_rank):
            ...
            expert_tokens_total = tl.int64(0)
            for remote_r in range(world_size):
            ...
            padded_tokens = ((expert_tokens_total + 31) // 32) * 32
    ...
    for expert_idx in range(num_experts_per_rank):
        ...
        if expert_tokens > 0:
            ...
            cumulative_tokens_before = tl.int64(0)
